...
post_args.add_argument("imdbID", type=str, required=True, help="imdbID is required")
...
post_args.add_argument('Type', type=str, required=True, help="Type is required")
post_args.add_argument('Poster', type=str, required=True, help="Poster is required")

delete_args = reqparse.RequestParser()
delete_args.add_argument("imdbID", type=str, required=True, help="imdbID is required")
...
@app.route('/local', methods=['GET', 'POST', 'PUT', 'DELETE'])
def local():
